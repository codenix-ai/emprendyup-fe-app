                  ...
                  >
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-500 to-blue-500 flex items-center justify-center text-gray-900 dark:text-white font-semibold text-sm">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-700 dark:text-slate-300 max-w-md">
                        {message.text}
                      </div>
                    </td>
                    <td className="px-6 py-4">
              ...
              {filteredMessages.map((message) => (
                ...
                >
                  <div className="flex items-start gap-3 mb-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-blue-500 flex items-center justify-center text-gray-900 dark:text-white font-semibold">
                      {getInitials(message.contact.name || message.contact.phoneNumber)}
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-100 dark:bg-slate-700/30 rounded-lg p-3">
                      <p className="text-sm text-gray-700 dark:text-slate-300">{message.text}</p>
                    </div>
